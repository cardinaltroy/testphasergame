    ...
    return (
        <div className="UI Menu">
            <div className="menuDiff">
                <div className='btnSelect' onClick={() => play(4, 10)}>1 Level <br/>(cards:4, random:10)</div>
                ...
                <div className='btnSelect' onClick={() => play(6, 10)}>4 Level <br/>(cards:6, random:10)</div>
                ...
                <div className='btnSelect' onClick={() => play(8, 20)}>7 Level <br/>(cards:8, random:20)</div>
                ...
                <div className='btnSelect' onClick={() => play(13, 20)}>10 Level <br/>(cards:13, random:20)</div>
